...
> S8-17 `(?, ?)` refinement) landed direct-to-`main` on 2026-08-21. Next up per the suggested
> order: **S8-21** (filterable namespace picker, own branch), then **Batch E** (S8-13 layout
> config). S8-18 (APPENG-6149, prune stale robots) is another follow-up feature with its own branch.
